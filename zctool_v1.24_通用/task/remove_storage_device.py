...
class RemoveStorageDeviceTask(BaseTask):
    ...
    def __init__(self, task_type, messsage_handler,
        ...
        BaseTask.__init__(self, task_type, RequestDefine.remove_storage_device,
                          messsage_handler, logger_name)
        
        self.addTransferRule(state_initial, AppMessage.RESPONSE,
                             RequestDefine.remove_storage_device, result_success,
                             self.onQuerySuccess)
        self.addTransferRule(state_initial, AppMessage.RESPONSE,
                             RequestDefine.remove_storage_device, result_fail,
                             self.onQueryFail)
    ...
    def onQuerySuccess(self, msg, session):
        ...
        self.info("[%08X]remove storage device success"%
                       (session.session_id))
