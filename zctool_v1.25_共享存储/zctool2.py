        ...
        if param_image(param_modify_service,argc) == CHECK_PASS:
            try:
                ...
                if service != None:
                    ...
                    #parameter initail and begin test.
                    enviro["type1"] = param_modify_service['-t']
                    enviro["target"] = param_modify_service['-target']
                    enviro["disk_type"] = param_modify_service['-disk_type']
                    enviro["dist_source"] = param_modify_service['-dist_source']
